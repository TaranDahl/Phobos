...
[SOMESW]                                     ; 任意超武
SuperWeaponSidebar.Allow=yes                 ; 布尔值，该超武是否优先在左侧边栏显示
...
SuperWeaponSidebar.Max=0
SuperWeaponSidebar.MaxColumns=4
SuperWeaponSidebar.CameoHeight=50
SuperWeaponSidebar.LeftOffset=5
```

```{warning}
- 目前，同时使用 `SuperWeaponSidebar.Allow` 、`LimboDelivery` 和 `UseAITargeting` 会有问题，请等待修复
```
