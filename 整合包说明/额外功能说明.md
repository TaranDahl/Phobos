...
SuperWeaponSidebar.TopPCX=                   ; PCX文件，需要后缀，玩家属于该阵营时，超武左侧边栏的背景顶部素材，素材大小为 (`SuperWeaponSidebar.Interval` + 60) × 本素材高度
...
SuperWeaponSidebar.BottomPCX=                ; PCX文件，需要后缀，玩家属于该阵营时，超武左侧边栏的背景底部素材，素材大小为 (`SuperWeaponSidebar.Interval` + 60) × 本素材高度
