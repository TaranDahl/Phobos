...
### 2025.2.??  `Phobos-build-45+3_16` -> `Phobos-build-45+3_17`

 > - `( 0 )` 合并 Phobos-develop 近期所有改动（*2025.2.14 - `commit dbf7f74eecc375765ca21ba3120dda24080ca3f9`*）
 >   - *`commit 02da3f9b...`* 更改翻译官方中文文档
 >   - *`commit dbf7f74e...`* 修复仅使用 `BarracksExitCell` 时飞行步兵会打断步兵工厂的问题
 > - `(1/3)` 现在 `ExtendedBuildingPlacing` 能够分别让科技建筑和防御建筑等待放置，并在图标变灰时取消等待
