...
public:
	...
	static bool ShouldExistGreyCameo(const HouseClass* const pHouse, const TechnoTypeClass* const pType, const TechnoTypeClass* const pAuxType, const TechnoTypeClass* const pNegType);
