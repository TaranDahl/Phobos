...
public:
	...
	static int CountOwnedPresentWithDeployOrUpgrade(HouseClass* pHouse, TechnoTypeClass* pTechnoType, bool upgrade = false, bool deploy = false);
	static int CountOwnedPresentWithDeployOrUpgrade(HouseClass* pHouse, UnitTypeClass* pUnitType, bool deploy = false);
