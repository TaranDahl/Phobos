...
{
	INI_EX exINI(pINI);
	this->SourceCoord.Read(exINI, pSection, "Trajectory.Parabola.SourceCoord");
	this->TargetCoord.Read(exINI, pSection, "Trajectory.Parabola.TargetCoord");
	this->MirrorCoord.Read(exINI, pSection, "Trajectory.Parabola.MirrorCoord");
	this->TheDuration.Read(exINI, pSection, "Trajectory.Parabola.TheDuration");
	this->IsLaser.Read(exINI, pSection, "Trajectory.Parabola.IsLaser");
	this->IsSupported.Read(exINI, pSection, "Trajectory.Parabola.IsSupported");
	this->IsHouseColor.Read(exINI, pSection, "Trajectory.Parabola.IsHouseColor");
	this->IsSingleColor.Read(exINI, pSection, "Trajectory.Parabola.IsSingleColor");
	this->LaserInnerColor.Read(exINI, pSection, "Trajectory.Parabola.LaserInnerColor");
	this->LaserOuterColor.Read(exINI, pSection, "Trajectory.Parabola.LaserOuterColor");
	this->LaserOuterSpread.Read(exINI, pSection, "Trajectory.Parabola.LaserOuterSpread");
	this->LaserThickness.Read(exINI, pSection, "Trajectory.Parabola.LaserThickness");
	this->LaserDuration.Read(exINI, pSection, "Trajectory.Parabola.LaserDuration");
	this->LaserDelay.Read(exINI, pSection, "Trajectory.Parabola.LaserDelay");
	this->DamageDelay.Read(exINI, pSection, "Trajectory.Parabola.DamageDelay");
}
...
void ParabolaTrajectory::OnUnlimbo(BulletClass* pBullet, CoordStruct* pCoord, BulletVelocity* pVelocity)
{
	...
	if (pBullet->Owner)
	{
		...
		this->SetParabolaDirection(pBullet, pBullet->Owner->GetCoords(), pBullet->TargetCoords);
	}
	else
	{
		...
		this->SetParabolaDirection(pBullet, pBullet->SourceCoords, pBullet->TargetCoords);
	}
...
bool ParabolaTrajectory::OnAI(BulletClass* pBullet)
{
	...
	if (this->IsLaser && this->LaserTimer.Completed())
		this->DrawParabolaLaser(pBullet, pTechno, pOwner);
...
void ParabolaTrajectory::GetTechnoFLHCoord(BulletClass* pBullet, TechnoClass* pTechno)
{
...
void ParabolaTrajectory::CheckMirrorCoord(TechnoClass* pTechno)
{
...
void ParabolaTrajectory::SetParabolaDirection(BulletClass* pBullet, CoordStruct theSource, CoordStruct theTarget)
{
...
int ParabolaTrajectory::GetFloorCoordHeight(BulletClass* pBullet, CoordStruct coord)
{
...
bool ParabolaTrajectory::PlaceOnCorrectHeight(BulletClass* pBullet)
{
...
void ParabolaTrajectory::DrawParabolaLaser(BulletClass* pBullet, TechnoClass* pTechno, HouseClass* pOwner)
{
...
void ParabolaTrajectory::DetonateLaserWarhead(BulletClass* pBullet, TechnoClass* pTechno, HouseClass* pOwner)
{
